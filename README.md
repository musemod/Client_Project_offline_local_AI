...
## My Contribution
- Implemented the offline / local AI backend to a chatbot AI assistant.
- For more information on architecture, setup, hardware specifications, see the docs folder.
